    ...
    s = function(t) {
        ...
        },
        {
            ...
            value: function() {
                ...
                n = t.shift() - 105,
                r = c.SET_BY_CODE[n];
                if (void 0 === r) throw new RangeError("The encoding does not start with a start character."); ! 0 === this.shouldEncodeAsEan128() && t.unshift(c.FNC1);
                var o = e.next(t, 1, r);
                return {
...
function(t, e, n) {
    ...
    function r(t) {
        for (var e = 0,
        n = 0; n < t.length; n++) {
            var r = parseInt(t[n]); (n + t.length) % 2 == 0 ? e += r: e += 2 * r % 10 + Math.floor(2 * r / 10)
        }
        return (10 - e % 10) % 10
    }
    function o(t) {
        for (var e = 0,
        n = [2, 3, 4, 5, 6, 7], r = 0; r < t.length; r++) {
    ...
    d = function(t) {
        ...
        },
        {
            ...
            value: function() {
                ...
                return t += "101",
                t += (0, s.
            default)(this.data.substr(0, 6), "LLLLLL"),
                t += "01010",
                t += (0, s.
            default)(this.data.substr(6, 6), "RRRRRR"),
                t += "101",
                {
                    data: t,
                    text: this.text
        ...
        },
        {
            ...
            value: function() {
                ...
                t.push({
                    data: (0, s.
                default)(this.data.substr(1, 5), "LLLLL"),
...
function(t, e, n) {
    ...
    function i(t, e, n) {
        ...
        default)(e, u.options);
            ...
            u.height = r(u, c),
            u.barcodePadding = o(a, l, c)
        }
    }
    function a(t) {
        for (var e = 0,
        n = 0; n < t.length; n++) e += t[n].width;
        return e
    }
    function u(t) {
        for (var e = 0,
        n = 0; n < t.length; n++) t[n].height > e && (e = t[n].height);
        return e
    }
    function f(t, e, n) {
        var r;
...
function(t, e, n) {
    ...
    function o(t, e, n) {
        ...
        o = (0, p.
    default)(o);
        for (var i = 0; i < o.length; i++) o[i].options = (0, s.
    default)(n, o[i].options);
        return o
    }
    function i() {
        return f.
    default.CODE128 ? "CODE128": Object.keys(f.
    default)[0]
    }
    function a(t, e, n) {
        e = (0, p.
    default)(e);
        for (var r = 0; r < e.length; r++) e[r].options = (0, s.
    default)(n, e[r].options),
        (0, h.
    default)(e[r].options); (0, h.
    default)(n),
    ...
    x = function(t, e, n) {
        ...
        return r._renderProperties = (0, b.
    default)(t),
        r._encodings = [],
        r._options = m.
    default,
        r._errorHandler = new O.
    default(r),
        void 0 !== e && (n = n || {},
...
default, P);
    j.prototype.options = function(t) {
        return this._options = (0, s.
    default)(this._options, t),
        this
    },
    ...
    j.prototype.init = function() {
        if (this._renderProperties) {
            ...
            for (var e in this._renderProperties) {
                ...
                var n = (0, s.
            default)(this._options, t.options);
                "auto" == n.format && (n.format = i()),
                this._errorHandler.wrapBarcodeCall(function() {
                    var e = n.value,
                    r = f.
                default[n.format.toUpperCase()],
                    i = o(e, r, n);
                    a(t, i, n)
                })
            }
...
function(t, e, n) {
    ...
    l = function(t) {
        function e(t, n) {
            if (o(this, e), /^[\x00-\x7F\xC8-\xD3]+$/.test(t)) var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, (0, s.
        default)(t), n));
...
default = function(t) {
        ...
        return e.replace(/[\xCD\xCE]([^])[\xCD\xCE]/,
        function(t, e) {
...
function(t, e, n) {
    ...
    c = function(t) {
        ...
        },
        {
            ...
            value: function() {
                for (var t = "1010",
                e = 0; e < this.data.length; e += 2) t += this.calculatePair(this.data.substr(e, 2));
                return t += "11101",
                {
                    data: t,
                    text: this.text
        ...
        },
        {
            ...
            value: function(t) {
                for (var e = "",
                n = this.binaryRepresentation[t[0]], r = this.binaryRepresentation[t[1]], o = 0; o < 5; o++) e += "1" == n[o] ? "111": "1",
                e += "1" == r[o] ? "000": "0";
                return e
            }
        }]),
...
function(t, e, n) {
    ...
    function a(t) {
        for (var e = 0,
        n = 0; n < 13; n++) e += parseInt(t[n]) * (3 - n % 2 * 2);
    ...
    s = function(t) {
        ...
        },
        {
            ...
            value: function() {
                for (var t = "1010",
                e = 0; e < 14; e += 2) t += this.calculatePair(this.data.substr(e, 2));
                return t += "11101",
                {
                    data: t,
                    text: this.text
...
function(t, e, n) {
    ...
    c = function(t) {
        ...
        },
        {
            key: "encode",
            value: function() {
                for (var t = [], e = this.getEncodings(), n = 0; n < this.data.length; n++) t.push(e[this.data.charAt(n)]),
...
function(t, e, n) {
    ...
    c = function(t) {
        ...
        a(e, [{
            key: "encode",
            value: function() {
                for (var t = this.number,
                e = ""; ! isNaN(t) && 0 != t;) t % 2 == 0 ? (e = "11100" + e, t = (t - 2) / 2) : (e = "100" + e, t = (t - 1) / 2);
...
function(t, e, n) {
    ...
    function o(t) {
        ...
        for (var n in f.
    default) f.
    default.hasOwnProperty(n) && (t.hasAttribute("jsbarcode-" + n.toLowerCase()) && (e[n] = t.getAttribute("jsbarcode-" + n.toLowerCase())), t.hasAttribute("data-" + n.toLowerCase()) && (e[n] = t.getAttribute("data-" + n.toLowerCase())));
        ...
        return o(t, [{
            ...
            value: function() {
                ...
                for (var t = 0; t < this.encodings.length; t++) {
                    var e = (0, a.
                default)(this.options, this.encodings[t].options);
...
function(t, e, n) {
    ...
    c = function() {
        ...
        return o(t, [{
            ...
            value: function() {
                ...
                for (var e = 0; e < this.encodings.length; e++) {
                    ...
                    r = (0, a.
                default)(this.options, n.options),
        ...
        },
        {
            key: "prepareSVG",
            value: function() {
                for (; this.svg.firstChild;) this.svg.removeChild(this.svg.firstChild); (0, u.calculateEncodingAttributes)(this.encodings, this.options);
        ...
        },
        {
            ...
            value: function(t, e, n) {
                ...
                for (var i = 0,
                a = 0,
                u = 0; u < o.length; u++) a = u * e.width + n.barcodePadding,
                "1" === o[u] ? i++:i > 0 && (this.drawRect(a - e.width * i, r, e.width * i, e.height, t), i = 0);
